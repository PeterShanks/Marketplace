...
public class Money : ValueObject
{
    ...
    public Money Add(Money summand)
    {
        if (summand.Currency != Currency)
            throw new DomainExceptions.CurrencyMismatchException("Cannot sum amounts with different currencies");
    ...
    public Money Subtract(Money subtrahend)
    {
        if (subtrahend.Currency != Currency)
            throw new DomainExceptions.CurrencyMismatchException("Cannot subtract amounts with different currencies");
